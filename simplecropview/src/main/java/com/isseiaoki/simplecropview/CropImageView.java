...
public class CropImageView extends ImageView {
    ...
    private HandlesMode mHandlesMode = HandlesMode.Rectangle;
    ...
    public Parcelable onSaveInstanceState() {
        ...
        ss.handlesMode = this.mHandlesMode;
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        this.mHandlesMode = ss.handlesMode;
    ...
    private void drawHandles(Canvas canvas) {
        if (mIsHandleShadowEnabled) {
            drawHandlesShadows(canvas);
        }
        if (mHandlesMode == HandlesMode.RoundShape) {
     ...
     * @param canvas
     */
    private void drawHandlesShadows(Canvas canvas) {
        mPaintFrame.setStyle(Paint.Style.FILL);
        ...
        if (mHandlesMode == HandlesMode.RoundShape) {
            ...
            canvas.drawRect(rect.left, rect.top - 8, rect.left + 35, rect.top, mPaintFrame);
            canvas.drawRect(rect.left - 8, rect.top - 8, rect.left, rect.top + 35, mPaintFrame);


            canvas.drawRect(rect.right, rect.top - 8, rect.right - 35, rect.top, mPaintFrame);
            canvas.drawRect(rect.right + 8, rect.top - 8, rect.right, rect.top + 35, mPaintFrame);

            canvas.drawRect(rect.left - 8, rect.bottom, rect.left + 35, rect.bottom + 8, mPaintFrame);
            canvas.drawRect(rect.left - 8, rect.bottom, rect.left, rect.bottom - 35, mPaintFrame);

            canvas.drawRect(rect.right, rect.bottom + 8, rect.right - 35, rect.bottom, mPaintFrame);
            canvas.drawRect(rect.right + 8, rect.bottom + 8, rect.right, rect.bottom - 35, mPaintFrame);
    ...
    public enum HandlesMode {
        RoundShape(0), Rectangle(1);
        private final int ID;

        HandlesMode(final int id) {
            this.ID = id;
        }
